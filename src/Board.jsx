...
export function Board({style: colorThemeBoard}) {
  ...
  function handleClassNames(circlePos){
    return `${circlePos} ${state[circlePos]["isHovering"] && "hover"} ${
  ...
  return (
    <div className="container" style={colorThemeBoard}>
      <div className="top">
        {/* ========top circles start================== */}
        <div
        ...
        <div className="middle">
          ...
          <div
            ...
            onMouseOver={() => handleMouseOverAndOut("middle-top-right", true)}
            onMouseOut={() => handleMouseOverAndOut("middle-top-right", false)}
          ></div>

          <div
            className={handleClassNames("middle-top-middle")}
            onClick={() => handleClick("middle-top-middle")}
            onMouseOver={() => handleMouseOverAndOut("middle-top-middle", true)}
            onMouseOut={() => handleMouseOverAndOut("middle-top-middle", false)}
          ></div>
          ...
          <div className="bottom">
            ...
            <div
              ...
              onMouseOver={() => handleMouseOverAndOut("bottom-top-left", true)}
              onMouseOut={() => handleMouseOverAndOut("bottom-top-left", false)}
            ></div>
